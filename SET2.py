...
#____________________________________customizable constants______________________________________
display_width = 800
display_height = 600
number_of_cards=12
rows= 3
...
#____________________________________other constants___________________________________
playing = True
black = (0,0,0)
white = (255,255,255)
blue =(0,0,255)
...
def Find_all_Sets_with(card,cards_in_play,set_list,skip_list):
    ...
    skip_list2 = copy.copy(skip_list)
    for card1 in cards_in_play:
        if card1 not in skip_list:
            skip_list2.append(card1)
